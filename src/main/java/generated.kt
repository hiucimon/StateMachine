...
//    __ADD_TRANSITION__("CAMPAIGNMODE","EOL","[\r\n]","__return__")
    ...
    __ADD_TRANSITION__("START","ID","[a-zA-Z0-9]+")
    __ADD_TRANSITION__("START","COLON",":")
    __ADD_TRANSITION__("START","SEMICOLON",";")
    __ADD_TRANSITION__("START","SQUOTE","'","SINGLEQUOTES")
    __ADD_TRANSITION__("START","DQUOTE","\"","DOUBLEQUOTES")
    __ADD_TRANSITION__("START","ACTION","->","ACTIONMODE")
    __ADD_TRANSITION__("SINGLEQUOTES","SKIP","''","__SINGLEQUOTE__")
    __ADD_TRANSITION__("SINGLEQUOTES","QUOTESTRING","[^']+")
    __ADD_TRANSITION__("SINGLEQUOTES","END_SQUOTE","'","__return__")
    __ADD_TRANSITION__("DOUBLEQUOTES","SKIP","''","__DOUBLEQUOTE__")
    __ADD_TRANSITION__("DOUBLEQUOTES","DOUBLESTRING","[^']+")
    __ADD_TRANSITION__("DOUBLEQUOTES","END_DQUOTE","'","__return__")
    __ADD_TRANSITION__("ACTIONMODE","PUSH","pushMode\\(")
    __ADD_TRANSITION__("ACTIONMODE","NEWMODE","[a-zA-Z0-9]+")
    __ADD_TRANSITION__("ACTIONMODE","CLOSEPAREN","\\)")
}
